...
function render_global_styles() {
	...
	echo wp_get_global_stylesheet( [ 'variables' ] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
	// Also set the block-gap style, which isn't technically a theme variable.
	echo 'body { --wp--style--block-gap: 24px; }';
