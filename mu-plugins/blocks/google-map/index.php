...
function render( $attributes, $content, $block ) {
	...
	// Submitting the form navigates here, so an action that comes from a block attribute must not leave the site.
	$attributes['searchFormAction'] = wp_validate_redirect( (string) ( $attributes['searchFormAction'] ?? '' ), '' );
